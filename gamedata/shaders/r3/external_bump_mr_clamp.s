-- external_bump_mr_clamp.s : CLAMP-sampler variant of external_bump_mr.s (4.2). Selected when the
-- material's base-color sampler is CLAMP_TO_EDGE on both axes. Same bindings; smp_base is clamped.
