-- external_bump_ds.s : DOUBLE-SIDED variant of external_bump.s (no backface cull). Selected when the
-- glTF material has doubleSided=true. Same bindings as external_bump.s; the G-buffer pass + shadow caster
-- set dx10cullmode 1 (D3DCULL_NONE) and the PS flips the shading normal on back faces via SV_IsFrontFace.
