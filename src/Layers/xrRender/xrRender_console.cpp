...
void xrRender_initconsole()
{
	...
	CMD4(CCC_Vector4, "ssfx_volumetric", &ps_ssfx_volumetric, Fvector4().set(0, 0, 1.0, 0.0), Fvector4().set(1.0, 5.0, 5.0, 1.0)); // SSS UPDATE 24 -- binary range (w was [1,16], rejected SSS24 MCM values)
