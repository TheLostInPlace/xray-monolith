...
// RT - KD
		...
		if (RImplementation.o.dx10_msaa)
		{
            rt_Generic_0_r.create(r2_RT_generic0_r, w, h, HW.m_HDR10Achieved ? D3DFMT_A16B16G16R16F : D3DFMT_A8R8G8B8, SampleCount);
            rt_Generic_1_r.create(r2_RT_generic1_r, w, h, HW.m_HDR10Achieved ? D3DFMT_A16B16G16R16F : D3DFMT_A8R8G8B8, SampleCount);
			//rt_Generic.create		      (r2_RT_generic,w,h,   D3DFMT_A8R8G8B8, 1		);
		}
