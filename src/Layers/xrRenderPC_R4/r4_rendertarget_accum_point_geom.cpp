...
void CRenderTarget::accum_point_geom_create()
{
	...
	// vertices
	{
		...
		R_CHK(dx10BufferUtils::CreateVertexBuffer( &g_accum_point_vb, du_sphere_vertices, vCount*vSize, true, "accum point vb" ));
	}
	...
	// Indices
	{
		...
		R_CHK(dx10BufferUtils::CreateIndexBuffer( &g_accum_point_ib, du_sphere_faces, iCount*2, true, "accum point ib" ));
	}
}
