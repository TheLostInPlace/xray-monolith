...
void CRenderTarget::accum_omnip_geom_create()
{
	...
	// vertices
	{
		...
		R_CHK(dx10BufferUtils::CreateVertexBuffer( &g_accum_omnip_vb, du_sphere_part_vertices, vCount*vSize, true, "accum omnipart vb" ));
	}
	...
	// Indices
	{
		...
		R_CHK(dx10BufferUtils::CreateIndexBuffer( &g_accum_omnip_ib, du_sphere_part_faces, iCount*2, true, "accum omnipart ib" ));
	}
}
